...
function processTrainData()
  ...
  local trainData = torch.DiskFile(DIR .. FILENAMES[1], "r")
  trainData:binary()
  ...
  local trainLabels = torch.DiskFile(DIR .. FILENAMES[2], "r")
  trainLabels:binary()
...
local function processTestData()
  ...
  -- open training data file and check headers
  local testData = torch.DiskFile(DIR .. FILENAMES[3], "r")
  testData:binary()
  ...
  -- open labels data file and check headers
  local testLabels = torch.DiskFile(DIR .. FILENAMES[4], "r")
  testLabels:binary()
  ...
  -- output torch files
  torch.save(DIR .. 'test.t7', testSet)
end
